...
const COPY: Record<Language, {
  ...
  en: {
    ...
    primary: { title: "Primary endpoint", body: "Diagnostic concordance versus the standard reference, weighted quadratic κ ≥ 0.65 with 95% CI estimated by 10 000 bootstrap replicates." },
  ...
  fr: {
    ...
    primary: { title: "Critère primaire", body: "Concordance diagnostique versus la référence standard, κ quadratique pondéré ≥ 0,65 avec IC 95 % estimé par 10 000 réplications bootstrap." },
  ...
  de: {
    ...
    primary: { title: "Primärer Endpunkt", body: "Diagnostische Konkordanz vs. Referenzstandard, gewichtetes quadratisches κ ≥ 0,65 mit 95 %-KI durch 10 000 Bootstrap-Replikationen." },
