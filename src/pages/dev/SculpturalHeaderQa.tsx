 ...
 * Lists every interactive state of the sculptural header primitives
 * so reviewers can compare hover / focus-visible / active / disabled /
 * reduced-motion side by side, in both light and dark themes.
 *
    ...
    <main className="min-h-screen bg-background text-foreground p-8 space-y-12" id="main-content">
      <header className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground max-w-2xl">
          ...
          reduced-motion setting and re-test: underlines and magnetic effects
          must not animate.
        </p>
      </header>
      ...
      {/* ───────────────────────────────────────────────────────────── */}
      <section aria-labelledby="logo-h" className="space-y-4">
      ...
      {/* ───────────────────────────────────────────────────────────── */}
      <section aria-labelledby="breadcrumbs-h" className="space-y-4">
      ...
      {/* ───────────────────────────────────────────────────────────── */}
      <section aria-labelledby="mobile-h" className="space-y-4">
