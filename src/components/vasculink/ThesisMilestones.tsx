...
const MILESTONES: Milestone[] = [
  ...
  { id: "J3", month: "M30", title: "Clinical concordance", criterion: "Clinical concordance vs reference imaging on subset of CHUV cohort" },
  ...
  return (
    <Card className={className} data-testid="thesis-milestones">
      <CardHeader>
        ...
        <CardDescription>
          Structuring decision points of the VASCU-LINK doctoral program (CHUV/Lausanne).
        </CardDescription>
      </CardHeader>
      <CardContent>
