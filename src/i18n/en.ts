export const en = {
  ...
  home: {
    ...
    hero: {
      ...
      translationalAmbition: "Testing whether part of the angiographic function — mapping, deciding, planning, guiding, treating — can be progressively rebuilt in 4-zero.",
    ...
    fourZeroBanner: {
      ...
      pillars: "0 mSv · 0 contrast · 0 helium · BoM target < €15k · recycled & biosourced materials",
      ariaLabel: "VASCU-LINK 4-zero vascular cockpit signature",
    },
    completeness: {
