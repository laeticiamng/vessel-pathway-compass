export const en = {
  ...
  patientOutcomes: {
    ...
    subtitle: "Validated questionnaires for vascular quality of life assessment",
    ...
    vascuqol6Desc: "Vascular Quality of Life Questionnaire — 6 items (PAD-specific)",
    civiq14Desc: "Chronic Venous Insufficiency Questionnaire — 14 items",
    ...
    status: "Status",
    completed: "Completed",
    selectCase: "Select Patient Case",
    ...
    submitError: "Failed to submit questionnaire",
    scoreOptions: {
  ...
  clinicalPerformance: {
    ...
    subtitle: "Key performance indicators compared to European vascular benchmarks (ESVS / Vascunet)",
    complicationRate: "30-Day Complication Rate",
    meanTimeToProcedure: "Mean Time to Procedure",
    restenosisRate: "Re-stenosis Rate (6 mo)",
    ...
    complicationDesc: "Outcomes marked as \"complication\" within your cases, divided by total case count.",
    meanTimeDesc: "Average number of days between case creation and first intervention/procedure outcome.",
    restenosisDesc: "Outcomes marked as \"restenosis\" as a percentage of total cases.",
    satisfactionDesc: "Average normalized PROM score across all completed questionnaires.",
    benchmarkNote: "Based on ESVS guidelines and Vascunet registry aggregate data (2023–2024).",
  },

  // Risk Calculator
  riskCalculator: {
    title: "Vascular Risk Calculator",
    subtitle: "Interactive clinical scoring tools with instant results and treatment recommendations",
    clinicalSupport: "Clinical Decision Support",
    notSubstitute: "Not a substitute for clinical judgment",
    score2: {
      title: "SCORE2 — 10-Year CVD Risk",
      desc: "European Society of Cardiology risk estimation for fatal and non-fatal cardiovascular events",
      age: "Age (years)",
      sex: "Sex",
      male: "Male",
      female: "Female",
      ...
      calculate: "Calculate SCORE2 Risk",
      tenYearRisk: "10-Year CVD Risk",
      risk: "Risk",
      recommendation: "Treatment Recommendation",
      disclaimer: "Based on ESC/EAS 2021 guidelines. This is a simplified estimation — use validated SCORE2 charts for clinical decisions.",
      low: "Low",
      moderate: "Moderate",
      high: "High",
      veryHigh: "Very High",
      lowRec: "Lifestyle modification. Reassess in 5 years.",
      moderateRec: "Consider lipid-lowering therapy. Target LDL <2.6 mmol/L. Annual follow-up.",
      highRec: "Initiate statin therapy. Target LDL <1.8 mmol/L. Consider antihypertensive if SBP >140.",
      veryHighRec: "Intensive lipid-lowering (high-intensity statin ± ezetimibe). Target LDL <1.4 mmol/L. Antihypertensive therapy. Consider antiplatelet.",
    },
    wells: {
      title: "Wells Score — DVT Probability",
      desc: "Clinical prediction rule for deep vein thrombosis",
      score: "Wells DVT Score",
      lowProb: "Low probability",
      moderateProb: "Moderate probability",
      highProb: "High probability",
      approach: "Recommended Approach",
      disclaimer: "Based on Wells et al. Clinical decision rule. For clinical use, combine with D-dimer and imaging as appropriate.",
      criteria: {
        cancer: "Active cancer (treatment within 6 months)",
        paralysis: "Paralysis, paresis, or recent cast of lower extremity",
        bedridden: "Bedridden >3 days or major surgery within 12 weeks",
        tenderness: "Localized tenderness along deep venous system",
        swelling: "Entire leg swollen",
        calf: "Calf swelling >3cm compared to asymptomatic leg",
        pitting: "Pitting edema confined to symptomatic leg",
        collateral: "Collateral superficial veins (non-varicose)",
        previous: "Previously documented DVT",
        alternative: "Alternative diagnosis at least as likely as DVT",
      },
    },
    abi: {
      title: "ABI — Ankle-Brachial Index",
      desc: "Enter systolic blood pressure measurements (mmHg)",
      rightArm: "Right Arm (mmHg)",
      leftArm: "Left Arm (mmHg)",
      rightAnkle: "Right Ankle (mmHg)",
      leftAnkle: "Left Ankle (mmHg)",
      calculate: "Calculate ABI",
      rightABI: "Right ABI",
      leftABI: "Left ABI",
      ...
      severe: "Severe PAD / Critical Limb Ischemia",
      nonCompressible: "Non-compressible vessels (calcification)",
    },
  },
