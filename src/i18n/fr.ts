export const fr = {
  ...
  pricing: {
    ...
    researchPhase: {
      ...
      body: "VASCU-LINK est en phase de validation académique au Lausanne. Pour un accès institutionnel, un partenariat clinique ou une évaluation pilote, contactez l'équipe.",
