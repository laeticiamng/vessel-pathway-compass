  ...
  pages: {
    ...
    protocol: {
      ...
      endpoints: {
        ...
        primary: "Concordance segmentaire (Cohen's κ pondéré linéairement) entre VASCU-LINK et imagerie de référence sur la classification du degré de sténose en 4 classes.",
        primaryTarget: "Cible : κ ≥ 0,75 (borne inférieure IC 95 % ≥ 0,60).",
        rows: [
          { metric: "Sensibilité segmentaire (sténose ≥ 50 %)", target: "≥ 85 %" },
          { metric: "Spécificité segmentaire", target: "≥ 80 %" },
          { metric: "Concordance décisionnelle (3 classes thérapeutiques)", target: "κ ≥ 0,70" },
          { metric: "Reproductibilité inter-opérateur (n=30)", target: "κ ≥ 0,80" },
          { metric: "Évitabilité du contraste iodé", target: "Descriptif IC 95 %" },
          { metric: "Évitabilité de l'irradiation", target: "Descriptif IC 95 %" },
      ...
      stats: {
        ...
        subtitle: "Synthèse opérationnelle. Plan détaillé (SAP) en document séparé.",
        sampleLabel: "Taille d'échantillon",
        sample: "n = 144 patients à inclure (120 évaluables) ; α = 0,05 bilatéral, puissance = 0,90, κ attendu = 0,80, κ minimum acceptable = 0,60. Méthode de Donner & Eliasziw avec ajustement clusters intra-patient (GEE).",
        testsLabel: "Tests principaux",
        tests: "κ pondéré linéairement, IC 95 % par bootstrap (10 000 réplicats). Sensibilité/spécificité avec IC 95 % de Wilson. Concordance décisionnelle : κ pondéré quadratiquement.",
        missingLabel: "Données manquantes",
        missing: "Analyse principale en données complètes (Per-Protocol). Analyse de sensibilité avec imputation multiple (5 imputations, FCS) sur la population ITT.",
