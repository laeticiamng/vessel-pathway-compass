export const de = {
  ...
  sidebar: {
    ...
    patientOutcomes: "Patientenergebnisse",
  ...
  patientOutcomes: {
    ...
    subtitle: "Validierte Fragebögen zur Bewertung der vaskulären Lebensqualität",
    ...
    vascuqol6Desc: "Vaskulärer Lebensqualitätsfragebogen — 6 Items (pAVK-spezifisch)",
    civiq14Desc: "Fragebogen zur chronischen venösen Insuffizienz — 14 Items",
    noSubmissions: "Noch keine Einreichungen",
    startFirst: "Erste Bewertung starten",
    clinicalThreshold: "Klinische Schwelle",
    recentSubmissions: "Letzte Einreichungen",
    date: "Datum",
    questionnaire: "Fragebogen",
    score: "Score",
    status: "Status",
    completed: "Abgeschlossen",
    selectCase: "Patientenfall auswählen",
    chooseCase: "Fall auswählen...",
    questionnaireType: "Fragebogentyp",
    step: "Schritt",
    of: "von",
    back: "Zurück",
    next: "Weiter",
    ...
    submitSuccess: "Fragebogen erfolgreich eingereicht",
    submitError: "Fehler beim Einreichen des Fragebogens",
    scoreOptions: {
      none: "Keine / Überhaupt nicht",
      slightly: "Leicht",
      moderately: "Mäßig",
      quiteALot: "Ziemlich stark",
      extremely: "Extrem",
    },
  },

  clinicalPerformance: {
    title: "Dashboard für klinische Leistung",
    subtitle: "Leistungsindikatoren im Vergleich zu europäischen vaskulären Benchmarks (ESVS / Vascunet)",
    complicationRate: "30-Tage-Komplikationsrate",
    meanTimeToProcedure: "Mittlere Zeit bis zum Eingriff",
    restenosisRate: "Restenose-Rate (6 Mo.)",
    patientSatisfaction: "Patientenzufriedenheit",
    vsBenchmark: "vs EU-Benchmark",
    euBenchmark: "EU-Benchmark",
    methodology: "Methodik & Datenquellen",
    complicationDesc: "Als 'Komplikation' markierte Ergebnisse in Ihren Fällen, geteilt durch die Gesamtanzahl der Fälle.",
    meanTimeDesc: "Durchschnittliche Anzahl der Tage zwischen Fallerstellung und erstem Interventions-/Eingriffsergebnis.",
    restenosisDesc: "Als 'Restenose' markierte Ergebnisse als Prozentsatz der Gesamtfälle.",
    satisfactionDesc: "Durchschnittlicher normalisierter PROM-Score über alle abgeschlossenen Fragebögen.",
    benchmarkNote: "Basierend auf ESVS-Richtlinien und aggregierten Vascunet-Registerdaten (2023–2024).",
  },

  riskCalculator: {
    title: "Vaskulärer Risikorechner",
    subtitle: "Interaktive klinische Scoring-Tools mit sofortigen Ergebnissen und Behandlungsempfehlungen",
    clinicalSupport: "Klinische Entscheidungsunterstützung",
    notSubstitute: "Kein Ersatz für klinisches Urteil",
    score2: {
      title: "SCORE2 — 10-Jahres-KVD-Risiko",
      desc: "Risikoschätzung der Europäischen Gesellschaft für Kardiologie für tödliche und nicht-tödliche kardiovaskuläre Ereignisse",
      age: "Alter (Jahre)",
      sex: "Geschlecht",
      male: "Männlich",
      female: "Weiblich",
      ...
      calculate: "SCORE2-Risiko berechnen",
      tenYearRisk: "10-Jahres-KVD-Risiko",
      risk: "Risiko",
      recommendation: "Behandlungsempfehlung",
      disclaimer: "Basierend auf ESC/EAS 2021-Richtlinien. Dies ist eine vereinfachte Schätzung — verwenden Sie validierte SCORE2-Tabellen für klinische Entscheidungen.",
      low: "Niedrig",
      moderate: "Moderat",
      high: "Hoch",
      veryHigh: "Sehr hoch",
      lowRec: "Lebensstiländerung. Neubewertung in 5 Jahren.",
      moderateRec: "Lipidsenkende Therapie erwägen. Ziel-LDL <2,6 mmol/L. Jährliche Kontrolle.",
      highRec: "Statintherapie einleiten. Ziel-LDL <1,8 mmol/L. Antihypertensivum erwägen bei SBP >140.",
      veryHighRec: "Intensive Lipidsenkung (hochdosiertes Statin ± Ezetimib). Ziel-LDL <1,4 mmol/L. Antihypertensive Therapie. Thrombozytenaggregationshemmer erwägen.",
    },
    wells: {
      title: "Wells-Score — TVT-Wahrscheinlichkeit",
      desc: "Klinische Vorhersageregel für tiefe Venenthrombose",
      score: "Wells TVT Score",
      lowProb: "Geringe Wahrscheinlichkeit",
      moderateProb: "Mittlere Wahrscheinlichkeit",
      highProb: "Hohe Wahrscheinlichkeit",
      approach: "Empfohlenes Vorgehen",
      disclaimer: "Basierend auf Wells et al. Klinische Entscheidungsregel. Für klinische Anwendung mit D-Dimer und Bildgebung kombinieren.",
      criteria: {
        cancer: "Aktive Krebserkrankung (Behandlung innerhalb von 6 Monaten)",
        paralysis: "Lähmung, Parese oder kürzlicher Gips der unteren Extremität",
        bedridden: "Bettlägerig >3 Tage oder große Operation innerhalb von 12 Wochen",
        tenderness: "Lokalisierte Druckempfindlichkeit entlang des tiefen Venensystems",
        swelling: "Gesamtes Bein geschwollen",
        calf: "Wadenschwellung >3cm im Vergleich zum asymptomatischen Bein",
        pitting: "Eindrückbares Ödem auf das symptomatische Bein beschränkt",
        collateral: "Kollaterale oberflächliche Venen (nicht-varikös)",
        previous: "Zuvor dokumentierte TVT",
        alternative: "Alternativdiagnose mindestens so wahrscheinlich wie TVT",
      },
    },
    abi: {
      title: "ABI — Knöchel-Arm-Index",
      desc: "Geben Sie die systolischen Blutdruckmessungen ein (mmHg)",
      rightArm: "Rechter Arm (mmHg)",
      leftArm: "Linker Arm (mmHg)",
      rightAnkle: "Rechter Knöchel (mmHg)",
      leftAnkle: "Linker Knöchel (mmHg)",
      calculate: "ABI berechnen",
      rightABI: "Rechter ABI",
      leftABI: "Linker ABI",
      recommendation: "Klinische Empfehlung",
      normal: "Normal",
      borderline: "Grenzwertig",
      pad: "Periphere arterielle Verschlusskrankheit (pAVK)",
      severe: "Schwere pAVK / Kritische Ischämie",
      nonCompressible: "Nicht-kompressible Gefäße (Verkalkung)",
    },
  },
