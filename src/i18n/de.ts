export const de = {
  ...
  landing: {
    ...
    about: {
      title: "Wer wir sind",
      description: "AquaMR Flow ist ein akademisches Forschungsprojekt unter Leitung von Dr. Laëticia Moto-Ngane, Assistenzärztin für Innere Medizin (FMH-Weiterbildung, Angiologie). Ziel ist es, nicht-ionisierende, kontrastmittelsparende Gefäß-Workflows voranzutreiben — orientiert an realen interventionellen Bedürfnissen, nicht an generischen Vorlagen.",
      foundedLine: "Doktorarbeit-Forschungsprojekt — unabhängige akademische Arbeit",
      medreg: {
  ...
  procedurePlanner: {
    ...
    bbcaDisclaimer: "Nur explorative Forschung — BBCA ist ein präklinischer pflanzlicher Wirkstoff, außerhalb des L1-Thesis-Rahmens und außerhalb des Null-Kontrast-Pfads. Die berichtete Relaxivität ist ~3000× niedriger als Gadolinium und damit heute kein angiographisches Kontrastmittel. Nur zur visionären Forschungsplanung, niemals für den klinischen Einsatz.",
  ...
  digitalTwin: {
    ...
    segmentDetail: {
      contrastFree: {
        ...
        recBBCA: "BBCA-Biokontrast — nur explorative Forschung, kein angiographisches Mittel",
  ...
  simulation: {
    ...
    results: {
      ...
      correct: "Korrekt",
      review: "Schritt-für-Schritt-Review",
      ok: "Korrekt",
      ko: "Falsch",
    ...
    draft: "Entwurf",
    incomplete: "Unvollständiges Szenario",
    publishToggle: "Veröffentlichen / Zurücknehmen",
    publishUpdated: "Veröffentlichungsstatus aktualisiert",
    deleted: "Fall gelöscht",
    errorDeleting: "Fehler beim Löschen",
    deleteTitle: "Diesen Fall löschen?",
    deleteDesc: "Damit werden das Szenario und alle zugehörigen Sitzungen entfernt.",
    auditTitle: "Unvollständiges Szenario",
    auditDesc:
      "Einige Schritte haben keine definierte korrekte Antwort oder Begründung. Der Score kann unvollständig sein.",
    templateNote:
      "Ein Vorlagenszenario (3 bewertete Schritte mit Begründung) wird automatisch erstellt. Sie können es danach bearbeiten.",
  },
  ...
  fusionViewer: {
    ...
    modalities: {
      ...
      bioMra: {
        ...
        agentDesc: "BBCA (Betalain-basiertes Kontrastmittel) — aus Roter Beete, GRAS-klassifiziert. Nur explorativ: die berichtete Relaxivität ist ~3000× niedriger als Gadolinium — heute kein angiographisches Kontrastmittel.",
  ...
  home: {
    ...
    validation: {
      ...
      cards: [
        { title: "Primärer Endpunkt", desc: "Entscheidungs-Konkordanz (quadratisch gewichtetes κ, 3 Therapieklassen) zwischen der Entscheidung nach der Kartierung und der multidisziplinären Referenzentscheidung; Ziel κ ≥ 0,60 (untere 95 %-KI-Grenze ≥ 0,45). Die anatomische segmentale Konkordanz ist ein territorial stratifizierter, konfirmatorischer sekundärer Endpunkt." },
        { title: "Vergleichsgrößen", desc: "Einzelne dominante primäre Referenz (CTA), pro Patient vorab festgelegt; MRA bei Jod-Kontraindikation; DSA bei Diskordanz oder interventioneller Indikation ausgelöst. Standard-Duplexsonographie als Vergleichsgröße für den inkrementellen Wert." },
        ...
        { title: "Go / No-Go-Regeln", desc: "Vordefiniert a priori auf dem entscheidungsbezogenen Primärendpunkt: Go (κ ≥ 0,60), Neubewertung (0,45–0,60), No-Go (< 0,45). Zwischenanalyse zur Futilität bei n=100." },
      ],
  ...
  premiumGate: {
    title: "Modul mit kontrolliertem Zugang",
    desc: "Dieses Modul erfordert einen Prüfärzte-Zugang im Rahmen des Forschungsprotokolls.",
    featureDesc: "{{feature}} erfordert einen Prüfärzte-Zugang im Rahmen des Forschungsprotokolls.",
    betaNote: "Während der Validierungsphase sind die Module im Rahmen des Forschungsprotokolls zugänglich. Beantragen Sie den Prüfärzte-Zugang, um sie nach der Validierungsphase weiter nutzen zu können.",
    upgrade: "Prüfärzte-Zugang anfragen",
    limitReached: "Sie haben das kontrollierte Zugangslimit für {{feature}} erreicht. Beantragen Sie den Prüfärzte-Zugang für eine erweiterte Nutzung.",
    limitNear: "Sie haben {{current}} von {{limit}} {{feature}} im kontrollierten Zugang verwendet. Beantragen Sie den Prüfärzte-Zugang für eine erweiterte Nutzung.",
    features: {
      aiReports: "KI-Berichte",
      patients: "Patienten",
    },
  ...
  vasculink: {
    ...
    arch: {
      title: "VASCU-LINK — Wiederaufbau der angiographischen Funktion in 4-Null",
      subtitle: "Kartieren · Entscheiden · In Simulation führen · Präklinische Intervention vorbereiten",
      description: "Drei konzentrische Kreise · 4-Null angiographische Funktion · vaskuläre Nahversorgung.",
      tagline: "0 mSv · 0 injiziertes Kontrastmittel · 0 Helium · BoM-Ziel < 15 k€ · sparsames / recyceltes Design",
      cockpitBanner: "4-Null vaskuläres Cockpit · 0 mSv · 0 Gd / 0 Jod · 0 Helium · BoM-Ziel < 15 k€ · recycelte / biobasierte Materialien",
      positioningTitle: "Klinische Positionierung",
      positioningDoppler: "Doppler — hämodynamische Erstlinien-Grundlage (nicht ersetzt)",
      positioningVasculink: "VASCU-LINK — angiographische 4-Null-Kartierung als Zwischenschritt",
      ...
      l1Item2Sub: "Hämodynamische Erstlinien-Grundlage",
      l1Item3Title: "C4-i-Stratifikation",
      l1Item3Sub: "Klinisch–physiologische Diskordanz",
      l1Item4Title: "Vaskuläre PROMs",
      l1Item4Sub: "Gehen · Symptome · Lebensqualität",
      l1IndicationsTitle: "L1 Zielindikationen",
      l1Indications: "Symptomatische pAVK · klinisch–Doppler-Diskordanz · CKD / Diabetes / Fragilität · multietagige Läsionen · wiederholte Verlaufskontrolle",
      l1Routing: "L1-Ziel: den Patienten lesbar, klassifizierbar und zur richtigen Strategie steuerbar machen",
      l1RoutingDest: "optimierte medikamentöse Therapie · Überwachung · ergänzende Bildgebung · endovaskulär · chirurgisch",
      ...
      decisionOutputsTitle: "Strukturierter klinischer Output",
      decisionOutputs: "Nachvollziehbare therapeutische Steuerung · Entscheidungsbegründung · longitudinale Verlaufskontrolle · zeitliches Replay · A→E-Konformitätsscore",
      decisionSafetyTitle: "Vorab definierte Sicherheitsregel",
      decisionSafety: "Wenn AquaMR nicht interpretierbar → dokumentierter Fallback auf Angio-CT / MRA / konventionelle Angiographie.",
      ...
      l2Item3: "Nicht-strahlende geführte Punktion (Phantom)",
      l2Limit: "Keine humane interventionelle Anwendung in L2.",
      l3Title: "L3 — POST-PHD-VISION: präklinischer Proof of Concept",
      l3Badge: "Langzeit-Horizont",
      l3Desc: "Tiermodell / Kadaver · keine humane Revaskularisierung innerhalb der Doktorarbeit. L3 bereitet den translationalen Horizont vor, ohne klinische humane Aussage in diesem Stadium.",
      footerMain: "Ambition: ausgewählte angiographische Funktionen schrittweise ersetzen — nicht die gesamte konventionelle Angiographie — durch eine validierte, sichere und nachvollziehbare 4-Null-Kette.",
      footerSub: "L1 validiert sehen / entscheiden · L2 erforscht das Führen in der Simulation · L3 bereitet die präklinische Intervention vor.",
    },
    matrix: {
  ...
  pages: {
    changelog: {
      ...
      sections: {
        ...
        cadrage_methodologique: "Methodischer Rahmen",
        ajoute: "Hinzugefügt",
        modifie: "Geändert",
        garde_fous: "Schutzmaßnahmen",
        securite: "Sicherheit",
      },
    },
    common: {
    ...
    modules: {
      ...
      ctaSignup: "Prüfärzte-Konto erstellen",
    ...
    protocol: {
      ...
      comparators: {
        ...
        subtitle: "Einzelne dominante primäre Referenz (CTA), pro Patient vor der VASCU-LINK-Lesung vorab festgelegt; Sensitivitätsanalyse Referenz-für-Referenz. Verifikationsregel (Begg-Greenes) dokumentiert.",
        items: [
          { title: "CT-Angiographie (CTA) — primäre Referenz", desc: "Dominante Referenz für aorto-iliakale und femoro-popliteale Segmente; entspricht der realen klinischen Praxis." },
          { title: "MR-Angiographie (MRA)", desc: "Alternative Referenz bei Kontraindikation gegen jodhaltiges Kontrastmittel." },
          { title: "Digitale Subtraktionsangiographie (DSA)", desc: "Nur bei Diskordanz oder interventioneller Indikation ausgelöst. Unterhalb des Knies ist die DSA ein unvollkommener Standard (kann durchgängige distale Gefäße übersehen) — die Unterschenkel-Analyse wird als Mehrwert an Information formuliert, nicht als Konkordanz gegen eine unvollkommene Referenz." },
          { title: "Duplex-Sonographie (Vergleich für inkrementellen Wert)", desc: "Standardmäßige erste Linie; Vergleichsgröße zur Quantifizierung des inkrementellen Entscheidungswerts der kontrastfreien Kartierung." },
        ],
      },
      endpoints: {
        title: "Beurteilungskriterien",
        subtitle: "Einzelner primärer Endpunkt (Entscheidung), hierarchische sekundäre, unkorrigierte explorative.",
        primaryLabel: "Primärer Endpunkt",
        primary: "Entscheidungs-Übereinstimmung (quadratisch gewichtetes Cohen's κ, 3 Therapieklassen) zwischen der Entscheidung nach der Kartierung und der multidisziplinären Referenzentscheidung auf Basis der Standardbildgebung.",
        primaryTarget: "Ziel: κ ≥ 0,60 (untere 95 %-KI-Grenze ≥ 0,45).",
        rows: [
          { metric: "Inkrementeller Wert vs. Doppler/ABI allein (Netto-Reklassifikation)", target: "Deskriptives 95 %-KI" },
          { metric: "Anatomische Übereinstimmung — aorto-iliakal (gewichtetes κ)", target: "κ ≥ 0,75" },
          { metric: "Anatomische Übereinstimmung — femoro-popliteal (gewichtetes κ)", target: "κ ≥ 0,65" },
          { metric: "Anatomische Übereinstimmung — unterhalb des Knies (gewichtetes κ)", target: "Berichtet, deskriptiv" },
          { metric: "Segmentale Sensitivität / Spezifität (Stenose ≥ 50 %, aorto-femoral)", target: "Se ≥ 85 % · Sp ≥ 80 %" },
          { metric: "Inter-Reader-Reproduzierbarkeit, zentrale verblindete Lesung (n=30)", target: "κ ≥ 0,70" },
          { metric: "Vermeidung von Jodkontrast & Strahlung vs. Standardpfad", target: "Deskriptives 95 %-KI" },
          { metric: "Aufnahmezeit · Patiententoleranz (VAS 0–10)", target: "≤ 25 min · Median ≤ 2" },
          { metric: "Explorativ — durchgängige Unterschenkel-Segmente, auf Referenz nicht sichtbar", target: "Deskriptiv, unkorrigiert" },
        ],
      },
      stats: {
        title: "Statistischer Plan",
        subtitle: "Operative Zusammenfassung. Detaillierter Plan (SAP) als separates Dokument.",
        sampleLabel: "Stichprobengröße",
        sample: "n ≈ 320 einzuschließende Patienten (≈ 250 auswertbar); zweiseitiges α = 0,05, Power = 0,90. Fallzahl kalibriert auf den entscheidungsbezogenen Primärendpunkt (erwartetes κ = 0,70, minimal akzeptables κ = 0,45). Donner & Eliasziw-Methode mit Cluster-Anpassung innerhalb des Patienten (GEE).",
        testsLabel: "Hauptanalysen",
        tests: "Quadratisch gewichtetes κ, 95 %-KI durch Bootstrap (10 000 Wiederholungen). Sensitivität/Spezifität mit Wilson-95 %-KI.",
        missingLabel: "Fehlende Daten",
        missing: "Multiple Imputation durch verkettete Gleichungen (MICE), m = 20 Imputationen. Sensitivitätsanalysen inkl. Complete-Case und Tipping-Point.",
        interimLabel: "Zwischenanalyse",
        interim: "Futilitätsanalyse bei n=100 (O'Brien-Fleming-Regel, ohne α-Verbrauch auf Wirksamkeit).",
      },
      safety: {
      ...
      qa: {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Primärer Endpunkt: Entscheidungs-Konkordanz (quadratisch gewichtetes κ, 3 Therapieklassen) zwischen der Entscheidung nach der Kartierung und der multidisziplinären Referenzentscheidung, Ziel κ ≥ 0,60 (untere Grenze 95 %-KI ≥ 0,45). Die anatomische segmentale Konkordanz ist ein territorial stratifizierter, konfirmatorischer sekundärer Endpunkt. n ≈ 320 einzuschließende Patienten (≈ 250 auswertbar); α = 0,05 zweiseitig, Power = 0,90, Fallzahl kalibriert auf den entscheidungsbezogenen Primärendpunkt, Donner-&-Eliasziw-Methode mit Intra-Patienten-Cluster-Adjustierung (GEE). Fehlende Daten durch multiple Imputation mit verketteten Gleichungen (MICE, m = 20), mit Complete-Case- und Tipping-Point-Sensitivitätsanalysen. Futility-Analyse bei n=100 (O'Brien-Fleming, kein α-Verbrauch)."
          },
          {
      ...
      annexes: {
        ...
        referencesLibrary: {
          ...
          claims: [
            ...
            {
              claim: "Primärer Endpunkt: Entscheidungs-Konkordanz (quadratisch gewichtetes κ, 3 Therapieklassen) vs. multidisziplinäre Referenzentscheidung, Ziel κ ≥ 0,60; anatomische Konkordanz als konfirmatorischer sekundärer Endpunkt.",
              refs: [
      ...
      sections: {
        ...
        clinical: {
          ...
          items: [
            ...
            "Klinische Fragebögen (WIQ, VascuQol-6, 6-MWT) werden in der Sprache des Patienten mit linguistisch validierten FR/DE/EN-Versionen erhoben; Version pro Patient dokumentiert.",
  ...
  vascscreen: {
    ...
    adr: {
      ...
      items: {
        ...
        "ADR-004": { title: "PROMs in validierten FR/DE/EN-Versionen (WIQ · VascuQol-6 · 6-MWT)", rationale: "Linguistisch validierte Instrumente, an die Sprache des Patienten angepasst; Version pro Patient protokolliert." },
  ...
  l1: {
    ...
    c4i: {
      ...
      description: "Klinisch-bildgebende Konkordanz (C4-i v11.1, rekalibriert auf externer Validierungskohorte) und vom Patienten berichtete Outcome-Maße (WIQ · VascuQol-6 · 6-MWT), in der Sprache des Patienten mit linguistisch validierten FR / DE / EN-Versionen erhoben; die verwendete Version wird pro Patient dokumentiert.",
