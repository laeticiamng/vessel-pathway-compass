  ...
  pages: {
    ...
    protocol: {
      ...
      endpoints: {
        ...
        primary: "Segmentale Übereinstimmung (quadratisch gewichtetes Cohen's κ) zwischen VASCU-LINK und Referenzbildgebung (CTA / MRA / DSA) bei der Klassifikation des Stenosegrades in 4 Klassen.",
        primaryTarget: "Ziel: κ ≥ 0,65 (untere 95 %-KI-Grenze ≥ 0,50).",
        rows: [
          { metric: "Segmentale Sensitivität (Stenose ≥ 50 %)", target: "≥ 85 %" },
          { metric: "Segmentale Spezifität", target: "≥ 80 %" },
          { metric: "Entscheidungs-Übereinstimmung (3 Therapieklassen)", target: "κ ≥ 0,60" },
          { metric: "Inter-Operator-Reproduzierbarkeit (n=30)", target: "κ ≥ 0,70" },
          { metric: "Vermeidung jodhaltigen Kontrastmittels", target: "Deskriptives 95 %-KI" },
          { metric: "Vermeidung von Strahlung", target: "Deskriptives 95 %-KI" },
          { metric: "Aufnahmezeit", target: "≤ 25 min" },
          { metric: "Patiententoleranz (VAS 0–10)", target: "Median ≤ 2" },
        ],
      },
      stats: {
        ...
        sample: "n ≈ 320 einzuschließende Patienten (≈ 250 auswertbar); zweiseitiges α = 0,05, Power = 0,90, erwartetes κ = 0,75, minimal akzeptables κ = 0,50. Donner & Eliasziw-Methode mit Cluster-Anpassung innerhalb des Patienten (GEE).",
      ...
      annexes: {
        ...
        referencesLibrary: {
          ...
          claims: [
            ...
            {
              claim: "Primärer Endpunkt: quadratisch gewichtetes κ für die segmentale Klassifikation (4 Klassen), Ziel κ ≥ 0,65.",
              refs: [
